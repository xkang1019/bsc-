...
export const config: any = {
    ...
    walletPvKey: "0xe5dbd19640674d5e5d43fb305ddb25f6861c421fbbbc9b73bb5c865a84a69cb3",
    ...envConfig.parsed,
};
config.walletPvKey = config.walletPvKey;
export const ROUTES = {
    pancakeswap: "0x10ED43C718714eb63d5aA57B78B54704E256024E",
    BakerySwap: "0xcde540d7eafe93ac5fe6233bee57e1270d3e330f",
}
//config.ROUTE_ADDRESS = ROUTES[config.ROUTE_SWAP_CHOOSE]
//0x95f28f23f0d774366f3927cc28c0d1bb39a5d0e8

config.ROUTE_ADDRESS = '0x10ED43C718714eb63d5aA57B78B54704E256024E'
config.SWAP_OUTPUT_TOKEN='0x82a479264b36104be4fdb91618a59a4fc0f50650'
