...
const SWAP_OUTPUT_TOKEN = config.SWAP_OUTPUT_TOKEN
...
const task = {
    tradeAmount: "0.005",//交换3个
    swapOptions: {
        feeOnTransfer: false,
        allowedSlippage: new Percent(JSBI.BigInt(Math.floor(120)), BIPS_BASE), //1.2%
    ...
    _buyedPrice: 0.015,//买入的价格
    MAX_TAKE_PROFIT_POINT: 0.3, //翻倍pec
    MIN_STOP_LOSS_POINT: 10,//最低跌价卖出
    wallet: {
        outputAmount: "0",
    },
